...
class Runner:
        ...
        self.journal.append(
            {
                ...
                "proposal": {"theme": "Long-term vision", "goal": current_loop_plan["goal"], "working_on": current_loop_plan["working_on"]},
    ...
    def _run_block_planning_loop(self, runtime: dict[str, Any], loop_counter: int) -> None:
        ...
        current_loop_plan = {
            ...
            "working_on": f"block_{plan.block_id:03d}_planning",
        ...
        self.journal.append(
            {
                ...
                "proposal": {
                    ...
                    "working_on": current_loop_plan["working_on"],
                    "primary_pillar": plan.primary_pillar,
                    "block_id": plan.block_id,
                },
